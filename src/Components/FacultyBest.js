...
const FacultyBest = () => {
  ...
  const Teachers = ({ faculty }) => {
    return (
      <div className="py-6 px-10 shadow-xl flex flex-col items-center rounded-xl w-[252px] flex-shrink-0 border border-t-customBorderLightGrey hover:shadow-inner">
        <div className="mb-4">
  ...
  return (
    <div className="pt-[200px] pb-[100px] flex sm:mx-[60px] md:mx-[100px] lg:mx-[273.6px]">
      <div className="flex sm:w-[100%] md:w-[80%] lg:w-full max-w-[1200px]">
        <div>
        ...
        <div className="pl-[20px] pt-[10px]">
          ...
          <div className="flex gap-5 py-[32px] px-[16px] overflow-x-auto mt-7 scrollbar-hidden sm:w-[550px] md:w-[660px] lg:w-[900px]">
