...
import { addMentorShip, addStudent, setLearningModel, setProjects, setStuckList, setTestimonials, setTrustedLearners } from "../utils/studentSlice";
...
const useStudentData = ()=>{
  ...
  const fetchData = async ()=>{
    ...
    //console.log(responsedata.data.home_data.projects);
